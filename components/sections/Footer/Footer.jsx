      ...
      <div className="container mx-auto px-4 py-8 pb-24">
        ...
        <div className="flex justify-center gap-5 mb-8">
          <a
            ...
            className="bg-gray-900 text-white text-lg p-2 rounded-md inline-flex justify-center items-center w-10 h-10 hover:bg-gray-700 transition-colors"
            target="_blank"
        ...
        <span className="block mt-16 text-gray-900 text-center text-sm">
